module.exports = {
  ...
  props: {
    $url: "`/v1/components/a9b74ddd-39de-493f-84ab-9d87fcf23fee/data?start='${craneStates.filterRange[0]}'&end='${craneStates.filterRange[1]}'&department=${craneStates.department}`",
    method: 'get',
    $style: {
      width: '1300px',
      height: '390px'
