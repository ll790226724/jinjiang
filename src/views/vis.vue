<template>
  <div class="vis">
    ...
    <data-loader v-slot="{ results: results }" url="/v1/components/f4b74ddd-39de-493f-84ab-9d87fcf23fee/data?start=2018-01-01&end=2020-01-01" method="get" :data="[{label: '投诉类型', amount: 12}]" :style="{width: '384px', height: '290px', position: 'absolute', top: '576px', left: '1530px'}">
    ...
    <data-loader v-slot="{ results: results }" :url="`/v1/components/a9b74ddd-39de-493f-84ab-9d87fcf23fee/data?start='${craneStates.filterRange[0]}'&end='${craneStates.filterRange[1]}'`" method="get" :style="{width: '1300px', height: '390px', position: 'absolute', top: '104px', left: '330px'}">
