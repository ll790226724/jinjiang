<template>
  <div class="department">
    ...
    <data-loader ref="department-ranking" v-slot="{ results: results }" :url="`/v1/components/11b74ddd-39de-493f-84ab-9d87fcf23fee/data?start=${craneStates.filterRange[0]}&end=${craneStates.filterRange[1]}&department=${craneStates.department}`" method="get" :data="[{label: '承办单位', amount: 12}]" :style="{width: '316px', maxHeight: '470px', padding: '8px', overflow: 'scroll', position: 'absolute', top: '263px', left: '1580px'}">
