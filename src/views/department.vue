<template>
  <div class="department">
    ...
    <data-loader ref="overdue" v-slot="{ results: results }" :url="`/v1/components/04b74ddd-39de-493f-84ab-9d87fcf23fee/data?start=${craneStates.filterRange[0]}&end=${craneStates.filterRange[1]}&department=${craneStates.department}`" method="get" :data="[[0]]" :style="{width: '120px', height: '58px', position: 'absolute', top: '169px', left: '230px'}">
    ...
    <data-loader v-slot="{ results: results }" :url="`/v1/components/10b74ddd-39de-493f-84ab-9d87fcf23fee/data?start=${craneStates.filterRange[0]}&end=${craneStates.filterRange[1]}&department=${craneStates.department}`" method="get" :data="[{label: '投诉类型', amount: 12}]" :style="{width: '384px', height: '290px', position: 'absolute', top: '576px', left: '1530px'}">
