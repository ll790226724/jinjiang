<template>
  <div class="department">
    ...
    <div ref="page_two" class="carousel-item" :style="{transform: `translateX(${1920 * (2 - craneStates.pageIndex)}px)`}">
      ...
      <data-loader ref="ranking_rank" v-slot="{ results: results }" :url="`/v1/components/11b74ddd-39de-493f-84ab-9d87fcf23fee/data?start=${craneStates.filterRange[0]}&end=${craneStates.filterRange[1]}&department=${craneStates.department}`" method="get" :data="[{label: '承办单位', amount: 12}]" :style="{width: '436px', maxHeight: '440px', padding: '8px', overflow: 'scroll', position: 'absolute', top: '309px', left: '417px'}">
